      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardContent className="space-y-4 py-6">
            ...
            {info && step === "otp" && (
              <div className="rounded-md bg-emerald-50 dark:bg-emerald-950/40 px-3 py-2 text-sm text-emerald-700 dark:text-emerald-400">{info}</div>
            )}
            ...
            {step === "details" ? (
              <>
                ...
                <Button className="w-full" onClick={handleSendCode} disabled={submitting}>
